...
public final class IncidentTicket  {
    ...
    public static class Builder {
        ...
        public static Builder from(IncidentTicket t) {
            Builder b = new Builder(t.getId(), t.getReporterEmail(), t.getTitle());
            b.description(t.getDescription());
            b.priority(t.getPriority());
            b.tags(t.getTags());
            b.assigneeEmail(t.getAssigneeEmail());
            b.customerVisible(t.isCustomerVisible());
            b.slaMinutes(t.getSlaMinutes());
            b.source(t.getSource());
            return b;
        }
    }
}
